...
$dict.insert(String::from("alignment-adjust"), ($value).to_string().clone())
    };
(alignment_baseline, $dict:expr, $value:expr) => {
$dict.insert(String::from("alignment-baseline"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("animation-delay"), ($value).to_string().clone())
    };
(animation_direction, $dict:expr, $value:expr) => {
$dict.insert(String::from("animation-direction"), ($value).to_string().clone())
    };
(animation_duration, $dict:expr, $value:expr) => {
$dict.insert(String::from("animation-duration"), ($value).to_string().clone())
    };
(animation_fill_mode, $dict:expr, $value:expr) => {
$dict.insert(String::from("animation-fill-mode"), ($value).to_string().clone())
    };
(animation_iteration_count, $dict:expr, $value:expr) => {
$dict.insert(String::from("animation-iteration-count"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("animation-play-state"), ($value).to_string().clone())
    };
(animation_timing_function, $dict:expr, $value:expr) => {
$dict.insert(String::from("animation-timing-function"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("backface-visibility"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("background-attachment"), ($value).to_string().clone())
    };
(background_clip, $dict:expr, $value:expr) => {
$dict.insert(String::from("background-clip"), ($value).to_string().clone())
    };
(background_color, $dict:expr, $value:expr) => {
$dict.insert(String::from("background-color"), ($value).to_string().clone())
    };
(background_image, $dict:expr, $value:expr) => {
$dict.insert(String::from("background-image"), ($value).to_string().clone())
    };
(background_origin, $dict:expr, $value:expr) => {
$dict.insert(String::from("background-origin"), ($value).to_string().clone())
    };
(background_position, $dict:expr, $value:expr) => {
$dict.insert(String::from("background-position"), ($value).to_string().clone())
    };
(background_repeat, $dict:expr, $value:expr) => {
$dict.insert(String::from("background-repeat"), ($value).to_string().clone())
    };
(background_size, $dict:expr, $value:expr) => {
$dict.insert(String::from("background-size"), ($value).to_string().clone())
    };
(background_blend_mode, $dict:expr, $value:expr) => {
$dict.insert(String::from("background-blend-mode"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("border-bottom-color"), ($value).to_string().clone())
    };
(border_bottom_style, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-bottom-style"), ($value).to_string().clone())
    };
(border_bottom_width, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-bottom-width"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("border-left-color"), ($value).to_string().clone())
    };
(border_left_style, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-left-style"), ($value).to_string().clone())
    };
(border_left_width, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-left-width"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("border-right-color"), ($value).to_string().clone())
    };
(border_right_style, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-right-style"), ($value).to_string().clone())
    };
(border_right_width, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-right-width"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("border-top-color"), ($value).to_string().clone())
    };
(border_top_style, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-top-style"), ($value).to_string().clone())
    };
(border_top_width, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-top-width"), ($value).to_string().clone())
    };
(border_collapse, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-collapse"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("border-image-outset"), ($value).to_string().clone())
    };
(border_image_repeat, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-image-repeat"), ($value).to_string().clone())
    };
(border_image_slice, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-image-slice"), ($value).to_string().clone())
    };
(border_image_source, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-image-source"), ($value).to_string().clone())
    };
(border_image_width, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-image-width"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("border-bottom-left-radius"), ($value).to_string().clone())
    };
(border_bottom_right_radius, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-bottom-right-radius"), ($value).to_string().clone())
    };
(border_top_left_radius, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-top-left-radius"), ($value).to_string().clone())
    };
(border_top_right_radius, $dict:expr, $value:expr) => {
$dict.insert(String::from("border-top-right-radius"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("box-decoration-break"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("buffered-rendering"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("color-correction"), ($value).to_string().clone())
    };
(color_interpolation, $dict:expr, $value:expr) => {
$dict.insert(String::from("color-interpolation"), ($value).to_string().clone())
    };
(color_interpolation_filters, $dict:expr, $value:expr) => {
$dict.insert(String::from("color-interpolation-filters"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("color-rendering"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("column-rule-color"), ($value).to_string().clone())
    };
(column_rule_style, $dict:expr, $value:expr) => {
$dict.insert(String::from("column-rule-style"), ($value).to_string().clone())
    };
(column_rule_width, $dict:expr, $value:expr) => {
$dict.insert(String::from("column-rule-width"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("counter-increment"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("display-outside"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("dominant-baseline"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("enable-background"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("float-defer-column"), ($value).to_string().clone())
    };
(float_defer_page, $dict:expr, $value:expr) => {
$dict.insert(String::from("float-defer-page"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("font-feature-settings"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("font-language-override"), ($value).to_string().clone())
    };
(font_size_adjust, $dict:expr, $value:expr) => {
$dict.insert(String::from("font-size-adjust"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("font-variant-alternates"), ($value).to_string().clone())
    };
(font_variant_caps, $dict:expr, $value:expr) => {
$dict.insert(String::from("font-variant-caps"), ($value).to_string().clone())
    };
(font_variant_east_asian, $dict:expr, $value:expr) => {
$dict.insert(String::from("font-variant-east-asian"), ($value).to_string().clone())
    };
(font_variant_ligatures, $dict:expr, $value:expr) => {
$dict.insert(String::from("font-variant-ligatures"), ($value).to_string().clone())
    };
(font_variant_numeric, $dict:expr, $value:expr) => {
$dict.insert(String::from("font-variant-numeric"), ($value).to_string().clone())
    };
(font_variant_position, $dict:expr, $value:expr) => {
$dict.insert(String::from("font-variant-position"), ($value).to_string().clone())
    };
(footnote_policy, $dict:expr, $value:expr) => {
$dict.insert(String::from("footnote-policy"), ($value).to_string().clone())
    };
(glyph_orientation_horizontal, $dict:expr, $value:expr) => {
$dict.insert(String::from("glyph-orientation-horizontal"), ($value).to_string().clone())
    };
(glyph_orientation_vertical, $dict:expr, $value:expr) => {
$dict.insert(String::from("glyph-orientation-vertical"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("grid-auto-columns"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("grid-template-areas"), ($value).to_string().clone())
    };
(grid_template_columns, $dict:expr, $value:expr) => {
$dict.insert(String::from("grid-template-columns"), ($value).to_string().clone())
    };
(grid_template_rows, $dict:expr, $value:expr) => {
$dict.insert(String::from("grid-template-rows"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("grid-column-start"), ($value).to_string().clone())
    };
(grid_column_end, $dict:expr, $value:expr) => {
$dict.insert(String::from("grid-column-end"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("hanging-punctuation"), ($value).to_string().clone())
    };
(height, $dict:expr, $value:expr) => {
$dict.insert(String::from("height"), ($value).to_string().clone())
    };
(hyphenate_character, $dict:expr, $value:expr) => {
$dict.insert(String::from("hyphenate-character"), ($value).to_string().clone())
    };
(hyphenate_limit_chars, $dict:expr, $value:expr) => {
$dict.insert(String::from("hyphenate-limit-chars"), ($value).to_string().clone())
    };
(hyphenate_limit_last, $dict:expr, $value:expr) => {
$dict.insert(String::from("hyphenate-limit-last"), ($value).to_string().clone())
    };
(hyphenate_limit_lines, $dict:expr, $value:expr) => {
$dict.insert(String::from("hyphenate-limit-lines"), ($value).to_string().clone())
    };
(hyphenate_limit_zone, $dict:expr, $value:expr) => {
$dict.insert(String::from("hyphenate-limit-zone"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("image-orientation"), ($value).to_string().clone())
    };
(image_resolution, $dict:expr, $value:expr) => {
$dict.insert(String::from("image-resolution"), ($value).to_string().clone())
    };
(image_rendering, $dict:expr, $value:expr) => {
$dict.insert(String::from("image-rendering"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("initial-letters"), ($value).to_string().clone())
    };
(inline_box_align, $dict:expr, $value:expr) => {
$dict.insert(String::from("inline-box-align"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("justify-content"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("line-box-contain"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("list-style-image"), ($value).to_string().clone())
    };
(list_style_position, $dict:expr, $value:expr) => {
$dict.insert(String::from("list-style-position"), ($value).to_string().clone())
    };
(list_style_type, $dict:expr, $value:expr) => {
$dict.insert(String::from("list-style-type"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("marker-knockout-left"), ($value).to_string().clone())
    };
(marker_knockout_right, $dict:expr, $value:expr) => {
$dict.insert(String::from("marker-knockout-right"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("marquee-direction"), ($value).to_string().clone())
    };
(marquee_play_count, $dict:expr, $value:expr) => {
$dict.insert(String::from("marquee-play-count"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("mask-box-outset"), ($value).to_string().clone())
    };
(mask_box_repeat, $dict:expr, $value:expr) => {
$dict.insert(String::from("mask-box-repeat"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("mask-box-source"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("object-position"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("page-break-after"), ($value).to_string().clone())
    };
(page_break_before, $dict:expr, $value:expr) => {
$dict.insert(String::from("page-break-before"), ($value).to_string().clone())
    };
(page_break_inside, $dict:expr, $value:expr) => {
$dict.insert(String::from("page-break-inside"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("perspective-origin"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("region-fragment"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("scroll-behavior"), ($value).to_string().clone())
    };
(scroll_snap_coordinate, $dict:expr, $value:expr) => {
$dict.insert(String::from("scroll-snap-coordinate"), ($value).to_string().clone())
    };
(scroll_snap_destination, $dict:expr, $value:expr) => {
$dict.insert(String::from("scroll-snap-destination"), ($value).to_string().clone())
    };
(scroll_snap_points_x, $dict:expr, $value:expr) => {
$dict.insert(String::from("scroll-snap-points-x"), ($value).to_string().clone())
    };
(scroll_snap_points_y, $dict:expr, $value:expr) => {
$dict.insert(String::from("scroll-snap-points-y"), ($value).to_string().clone())
    };
(scroll_snap_type, $dict:expr, $value:expr) => {
$dict.insert(String::from("scroll-snap-type"), ($value).to_string().clone())
    };
(shape_image_threshold, $dict:expr, $value:expr) => {
$dict.insert(String::from("shape-image-threshold"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("shape-rendering"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("speak-punctuation"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("stroke-dasharray"), ($value).to_string().clone())
    };
(stroke_dashoffset, $dict:expr, $value:expr) => {
$dict.insert(String::from("stroke-dashoffset"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("stroke-linejoin"), ($value).to_string().clone())
    };
(stroke_miterlimit, $dict:expr, $value:expr) => {
$dict.insert(String::from("stroke-miterlimit"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("text-align-last"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("text-combine-upright"), ($value).to_string().clone())
    };
(text_decoration, $dict:expr, $value:expr) => {
$dict.insert(String::from("text-decoration"), ($value).to_string().clone())
    };
(text_decoration_color, $dict:expr, $value:expr) => {
$dict.insert(String::from("text-decoration-color"), ($value).to_string().clone())
    };
(text_decoration_line, $dict:expr, $value:expr) => {
$dict.insert(String::from("text-decoration-line"), ($value).to_string().clone())
    };
(text_decoration_style, $dict:expr, $value:expr) => {
$dict.insert(String::from("text-decoration-style"), ($value).to_string().clone())
    };
(text_decoration_skip, $dict:expr, $value:expr) => {
$dict.insert(String::from("text-decoration-skip"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("text-emphasis-color"), ($value).to_string().clone())
    };
(text_emphasis_style, $dict:expr, $value:expr) => {
$dict.insert(String::from("text-emphasis-style"), ($value).to_string().clone())
    };
(text_emphasis_position, $dict:expr, $value:expr) => {
$dict.insert(String::from("text-emphasis-position"), ($value).to_string().clone())
    };
(text_emphasis_skip, $dict:expr, $value:expr) => {
$dict.insert(String::from("text-emphasis-skip"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("text-orientation"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("text-size-adjust"), ($value).to_string().clone())
    };
(text_space_collapse, $dict:expr, $value:expr) => {
$dict.insert(String::from("text-space-collapse"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("text-underline-position"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("transform-origin"), ($value).to_string().clone())
    };
(transform_style, $dict:expr, $value:expr) => {
$dict.insert(String::from("transform-style"), ($value).to_string().clone())
    };
...
$dict.insert(String::from("transition-delay"), ($value).to_string().clone())
    };
(transition_duration, $dict:expr, $value:expr) => {
$dict.insert(String::from("transition-duration"), ($value).to_string().clone())
    };
(transition_property, $dict:expr, $value:expr) => {
$dict.insert(String::from("transition-property"), ($value).to_string().clone())
    };
(transition_timing_function, $dict:expr, $value:expr) => {
$dict.insert(String::from("transition-timing-function"), ($value).to_string().clone())
    };
